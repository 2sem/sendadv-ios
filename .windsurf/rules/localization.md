...
---
description: Localization rules for iOS app
---
...
- 현지화 문자열 이름: 가급적 원문의 뜻을 담고 간략하게(예: "Rule Title", "Enter rule title")
- 포맷 문자열은 "<Formatted Localized String Name>".localized().asFormat(...) 사용
- 현지화된 문자열은 빈 문자열로만으로 구성 될 수 없다.
...
4. Localizable.strings에 신규 현지화된 문자열 정의
